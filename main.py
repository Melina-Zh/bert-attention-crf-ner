...
from model.bert_attention_crf import DA_BERT_CRF
import os
...
def train(**kwargs):
    ...
    model = DA_BERT_CRF(config.bert_path, tagset_size, config.bert_embedding, config.bert_embedding, dropout_ratio=config.dropout_ratio, dropout1=config.dropout1, use_cuda=config.use_cuda)
